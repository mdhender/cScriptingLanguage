...
class ZString : public ZBase
{
   public:
      ...
      ZBaseLink(ZString&) conv8859to437();
      ZBaseLink(ZString&) conv437to8859();
      ...
      // stream i/o
      friend ZBaseLink(ostream&) operator << (ostream &aStream, const ZString& aString);
      friend ZBaseLink(istream&) operator >> (istream &aStream, ZString &aString);
      static ZBaseLink(ZString) lineFrom(istream &aStream, char aDelim = '\n');
